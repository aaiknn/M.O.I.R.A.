...
database_connection_aborted_error='Database connection self-test aborted during connection attempt.'
database_connection_error='Database connection self-test failed. This error is likely to be in your database setup or logic. Either that or the universe is now being weird.'
